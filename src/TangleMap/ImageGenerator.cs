...
public class ImageGenerator : IImageGenerator
{
    ...
    public async Task GenerateImage(string model, ModelType sourceType)
    {
        try
        {
            var byteSize = Encoding.ASCII.GetByteCount(model);
            if (byteSize > 50000)
            {
                Console.WriteLine();
                Console.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                Console.WriteLine($" Model size is limited to 50000 bytes. This model has a size of {byteSize} and an image cannot be generated by the service.");
                Console.WriteLine($" If you chose to save the model you can still run it locally (see varias model renderers). ");
                Console.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                Console.WriteLine();
                return;
            }
